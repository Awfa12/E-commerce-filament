<div>
   ...
   <div class="w-full min-h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
         ...
         <div class="flex flex-col lg:flex-row gap-8 lg:gap-20 items-center">
            ...
            <div class="order-2 lg:order-1 flex-1">
               ...
               <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">
                  Purchase wide varieties of electronics products like Smartphones, Laptops, Smartwatches, Television
                  and many more.
               </p>
            ...
            <!-- Image Container -->
            <div class="order-1 lg:order-2 relative lg:ms-4 w-full lg:max-w-[50%]">
